...
REM 
set SOURCE_DB=C:\inetpub\wwwroot\Auto-auction\db.sqlite3
set BACKUP_FOLDER=C:\Users\Administrator\Documents\AUTOBID WEEKLY DB BACKUPS
...
copy "%SOURCE_DB%" "%BACKUP_FOLDER%\db_backup_%timestamp%.sqlite3"

echo Backup completed: %BACKUP_FOLDER%\db_backup_%timestamp%.sqlite3
